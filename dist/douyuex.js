...
function selectHighestUnlockedBarrageColor() {
    ...
    let intID = setInterval(() => {
        ...
        for (let i = 0; i < items.length; i++) if (-1 === items[i].className.indexOf("is-lock")) lastUnlocked = items[i];
        if (lastUnlocked) lastUnlocked.click();
    }, 1e3);
}
